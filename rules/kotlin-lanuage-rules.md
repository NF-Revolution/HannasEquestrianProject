...
- Use internal visibility for values, function and classes that shouldn't be visible outside of the module.
- Always use visibility modifiers as I use explicit API.
